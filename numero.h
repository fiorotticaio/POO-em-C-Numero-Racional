...
static inline Numero_pt Num_copia	(Numero_t const * const me) { return (  me->metodo->copia(me)); }

static inline Numero_pt Num_atribui(Numero_t const * const  me, Numero_t * const  outro) {
	return (me->metodo->atribui(me, outro));
}

static inline Numero_pt Num_soma (Numero_t const * const  me, Numero_t const * const  outro, Numero_t * const res) {
	return (me->metodo->soma(me, outro, res));
}

static inline Numero_pt Num_subt (Numero_t const * const  me, Numero_t const * const  outro, Numero_t * const res){
	return (me->metodo->subt(me, outro, res));	
}

static inline Numero_pt Num_mult (Numero_t const * const  me, Numero_t const * const  outro, Numero_t * const res){
	return (me->metodo->mult(me, outro, res));
}

static inline Numero_pt Num_divd (Numero_t const * const  me, Numero_t const * const  outro, Numero_t * const res){
	return (me->metodo->divd(me, outro, res));
}

static inline Numero_pt Num_ac_soma (Numero_t * const  me, Numero_t const * const outro){
	return (me->metodo->ac_soma(me, outro));
}

static inline Numero_pt Num_ac_subt (Numero_t * const  me, Numero_t const * const outro){
	return (me->metodo->ac_subt(me, outro));
}

static inline Numero_pt Num_ac_mult (Numero_t * const  me, Numero_t const * const outro){
	return (me->metodo->ac_mult(me, outro));
}

static inline Numero_pt Num_ac_divd (Numero_t * const  me, Numero_t const * const outro){
	return (me->metodo->ac_divd(me, outro));
}

static inline int	Num_compara	(Numero_t const * const  me, Numero_t const * const  outro){
